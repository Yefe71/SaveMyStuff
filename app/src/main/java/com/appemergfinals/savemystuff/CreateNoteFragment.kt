...
import com.appemergfinals.savemystuff.util.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"Item Title is Required",Toast.LENGTH_SHORT).show()
        }
        else if (etNoteSubTitle.text.isNullOrEmpty()){

            Toast.makeText(context,"Date of Purchase is Required",Toast.LENGTH_SHORT).show()
        }

        else if (etNoteDesc.text.isNullOrEmpty()){

            Toast.makeText(context,"Additional Information is Required",Toast.LENGTH_SHORT).show()
        }
